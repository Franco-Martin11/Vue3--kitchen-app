<template>
  ...
  <section class="flex flex-col min-h-[80.5vh] m-[0_auto] gap-4">
    <slot name="content"></slot>
  </section>
  <footer class="flex p-4 min-h-[48px] items-center justify-between flex-row gap-2 w-full bg-color-accent">
